...
<div class="card-body">
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="row mb-3">
            <label for="usu_nome" class="col-md-4 col-form-label text-md-end">{{ __('Nome') }}</label>
        ...
        <div class="row mb-3">
            <label for="usu_senha" class="col-md-4 col-form-label text-md-end">{{ __('Senha') }}</label>
        ...
        <div class="row mb-3">
            <label for="usu_senha-confirm" class="col-md-4 col-form-label text-md-end">{{ __('Confirmar Senha') }}</label>
        ...
        <div class="row mb-0">
            <div class="col-md-8 offset-md-4">
                <button type="submit" class="btn btn-primary w-100">
                    <i class="bi bi-person-plus me-2"></i>{{ __('Cadastrar') }}
                </button>

                <div class="text-center mt-3">
                    <p class="text-muted">
                        {{ __('Já tem uma conta?') }}
                        <a href="{{ route('login') }}" class="btn btn-link p-0">{{ __('Entrar') }}</a>
                    </p>
                </div>
            </div>
        </div>

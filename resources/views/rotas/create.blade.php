            ...
            <div class="col-md-8">
                <div class="card" style="background-color: #13293A; border: none;">
                    <div class="card-header" style="border-bottom: 1px solid #f39c12;">
                        <h4 class="text-warning mb-0"><i class="bi bi-plus-circle me-2"></i>Nova Rota</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('rotas.store') }}" method="POST" id="formRota">
                            @csrf

                            <div class="mb-3">
                                <label for="rot_nome" class="form-label text-white">Nome da Rota <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('rot_nome') is-invalid @enderror" id="rot_nome" name="rot_nome" value="{{ old('rot_nome') }}" required style="background-color: #0f2438; color: #fff; border-color: #f39c12;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('rot_origem') is-invalid @enderror" id="rot_origem" name="rot_origem" value="{{ old('rot_origem') }}" required style="background-color: #0f2438; color: #fff; border-color: #f39c12;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('rot_destino') is-invalid @enderror" id="rot_destino" name="rot_destino" value="{{ old('rot_destino') }}" required style="background-color: #0f2438; color: #fff; border-color: #f39c12;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('rot_duracao_estimada') is-invalid @enderror" id="rot_duracao_estimada" name="rot_duracao_estimada" value="{{ old('rot_duracao_estimada') }}" required style="background-color: #0f2438; color: #fff; border-color: #f39c12;">

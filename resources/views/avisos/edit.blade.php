        ...
        <div class="col-md-8 offset-md-2">
            <div class="card" style="background-color: #1a3a52; border-color: #f39c12;">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('avisos.update', $aviso->avi_id) }}" method="POST" id="formAvisos">
                        @csrf
                        @method('PUT')

                        <!-- Campo ID (somente leitura) -->
                        <div class="mb-3">
                            <label for="avi_id" class="form-label text-white">
                            ...
                            <input 
                                ...
                                value="{{ $aviso->avi_id }}"
                                disabled
                                style="background-color: #0f2438; color: #7a8fa3; border-color: #f39c12;">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea 
                                ...
                                required
                                style="background-color: #0f2438; color: #fff; border-color: #f39c12;">{{ old('avi_descricao', $aviso->avi_descricao) }}</textarea>
                            @error('avi_descricao')
                        ...
                        <div class="mb-3">
                            ...
                            <input 
                                ...
                                required
                                value="{{ old('avi_datacadastro', $aviso->avi_datacadastro->format('Y-m-d')) }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input 
                                    type="text" 
                                    class="form-control" 
                                    value="{{ $aviso->created_at->format('d/m/Y H:i:s') }}"
                                    disabled
                                    style="background-color: #0f2438; color: #7a8fa3; border-color: #f39c12;">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input 
                                    type="text" 
                                    class="form-control" 
                                    value="{{ $aviso->updated_at->format('d/m/Y H:i:s') }}"
                                    disabled
                                    style="background-color: #0f2438; color: #7a8fa3; border-color: #f39c12;">
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-warning w-100" id="btnSalvar">
                                    <i class="bi bi-check-circle me-2"></i>Atualizar Aviso
                                </button>
                            </div>
                            <div class="col-md-6">
...
<script type="module">
    $(document).ready(function(){
        ...
        $('#formAvisos').on('submit', function(e){
            ...
            $('#btnSalvar').html('<span class="spinner-border spinner-border-sm me-2"></span>Atualizando...');
        });

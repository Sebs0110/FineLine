            ...
            <div class="col-md-8">
                <div class="card" style="background-color: #13293A; border: none;">
                    <div class="card-header" style="border-bottom: 1px solid #f39c12;">
                        <h4 class="text-warning mb-0"><i class="bi bi-pencil me-2"></i>Editar Ônibus</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('onibus.update', $onibus->oni_id) }}" method="POST" id="formOnibus">
                            @csrf
                            @method('PUT')

                            <div class="mb-3">
                                <label for="oni_placa" class="form-label text-white">Placa <span class="text-danger">*</span></label>
                                <input type="text" class="form-control @error('oni_placa') is-invalid @enderror" id="oni_placa" name="oni_placa" value="{{ old('oni_placa', $onibus->oni_placa) }}" required style="background-color: #0f2438; color: #fff; border-color: #f39c12;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('oni_renavan') is-invalid @enderror" id="oni_renavan" name="oni_renavan" value="{{ old('oni_renavan', $onibus->oni_renavan) }}" required style="background-color: #0f2438; color: #fff; border-color: #f39c12;">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('oni_modelo') is-invalid @enderror" id="oni_modelo" name="oni_modelo" value="{{ old('oni_modelo', $onibus->oni_modelo) }}" required maxlength="35" style="background-color: #0f2438; color: #fff; border-color: #f39c12;">
